...
public class SpotifyWithDependencies {
    private WebDriver driver;
    private SpotifyFillingRegistrationForm registrationForm;
    ...
    public void clickOnSignup() {
        ...
        registrationForm = new SpotifyFillingRegistrationForm(driver);
    ...
    @Test (dependsOnMethods = {"fillingRegistrationFields"})
